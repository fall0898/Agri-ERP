...
@Component({
  ...
  template: `
    <div class="min-h-screen flex bg-stone-900 lg:bg-neutral-50 relative overflow-hidden">
      ...
      <div class="lg:hidden absolute inset-0 z-0" aria-hidden="true">
        <svg class="w-full h-full" viewBox="0 0 390 844" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
          <defs>
            ...
            <radialGradient id="rgl" cx="50%" cy="71%" r="48%">
            ...
            <linearGradient id="rfld" x1="0" y1="0" x2="0" y2="1">
              <stop offset="0%" stop-color="#1a4010"/>
              <stop offset="100%" stop-color="#071208"/>
            </linearGradient>
            <linearGradient id="rsoil" x1="0" y1="0" x2="0" y2="1">
          ...
          <!-- Sky -->
          <rect width="390" height="844" fill="url(#rsk)"/>
          <!-- Horizon glow -->
          <ellipse cx="195" cy="602" rx="300" ry="180" fill="url(#rgl)"/>
          ...
          <!-- Field base -->
          <rect x="0" y="612" width="390" height="232" fill="url(#rfld)"/>

          <!-- Onion rows (perspective) -->
          <rect x="0" y="612" width="390" height="6"  fill="url(#rsoil)"/>
          <rect x="0" y="618" width="390" height="7"  fill="#24400e"/>
          <rect x="0" y="625" width="390" height="9"  fill="url(#rsoil)"/>
          <rect x="0" y="634" width="390" height="12" fill="#2d5212"/>
          <rect x="0" y="646" width="390" height="16" fill="url(#rsoil)"/>
          <rect x="0" y="662" width="390" height="20" fill="#386418"/>
          <rect x="0" y="682" width="390" height="26" fill="url(#rsoil)"/>
          <rect x="0" y="708" width="390" height="34" fill="#42761e"/>
          <rect x="0" y="742" width="390" height="44" fill="url(#rsoil)"/>
          <rect x="0" y="786" width="390" height="58" fill="#4e8824"/>

          <!-- Onion leaf arcs — row 6 -->
          ...
          <!-- Onion leaf arcs — row 10 (foreground) -->
      ...
      <!-- Right panel -->
      <div class="flex-1 flex items-center justify-center px-4 py-8 lg:px-6 lg:py-12 overflow-y-auto relative z-10">
